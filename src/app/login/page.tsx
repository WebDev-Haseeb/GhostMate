    ...
    <>
      ...
      <div className={styles.container}>
        <main className={styles.main}>
          <div className={styles.content}>
            <h1 className={styles.title}>GhostMate</h1>
            <p className={styles.subtitle}>Anonymous Conversations, Real Connections</p>
            ...
            >
              {loading ? (
                <span className={styles.loading}>Redirecting to Google...</span>
              ) : (
                <>
            ...
            {!privacyAccepted && (
              <p className={styles.hint}>
                Please accept the privacy notice above to continue
              </p>
            )}
